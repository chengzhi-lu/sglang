...
class LayerKVStats:
    ...
    virtual_kvc_scratch_generation_miss_count: int = 0
    ...
    kvc_evict_preselect_count: int = 0
    kvc_evict_preselect_hit_count: int = 0
    kvc_evict_preselect_invalid_count: int = 0
    kvc_evict_preselect_token_count: int = 0
    kvc_evict_preselect_ms: float = 0.0
    kvc_evict_schedule_build_count: int = 0
    kvc_evict_schedule_step_count: int = 0
    kvc_evict_schedule_hit_count: int = 0
    kvc_evict_schedule_invalid_count: int = 0
    kvc_evict_schedule_token_count: int = 0
    kvc_evict_schedule_build_ms: float = 0.0
    ...
    actual_kvc_tokens_by_layer: str = ""
    ...
    kvc_per_layer_invalid_reuse_count: int = 0
    kvc_per_layer_invalid_reuse_token_count: int = 0
    kvc_per_layer_overwrite_reuse_count: int = 0
    kvc_per_layer_overwrite_reuse_token_count: int = 0
    ...
    profile_cleanup_drop_entries_call_count: int = 0
    profile_cleanup_drop_entries_req_count: int = 0
    profile_cleanup_drop_entries_key_count: int = 0
    profile_cleanup_drop_entries_token_count: int = 0
    profile_cleanup_drop_entries_max_req_idx: int = -1
    profile_cleanup_drop_entries_max_req_key_count: int = 0
    profile_cleanup_drop_entries_max_req_token_count: int = 0
    profile_cleanup_drop_entries_max_req_seq_len: int = 0
    profile_cleanup_drop_entries_modes: str = ""
    profile_cleanup_drop_entries_req_summary: str = ""
    profile_cleanup_finished_call_count: int = 0
    profile_cleanup_finished_key_count: int = 0
    profile_cleanup_finished_token_count: int = 0
    profile_cleanup_release_call_count: int = 0
    profile_cleanup_release_key_count: int = 0
    profile_cleanup_release_token_count: int = 0
    ...
    layerkv_prewarm_count: int = 0
    layerkv_prewarm_ms: float = 0.0
    layerkv_prewarm_kvc_evict_ms: float = 0.0
    layerkv_prewarm_kvc_tokens: int = 0
    layerkv_prewarm_pressure_mb: float = 0.0
    layerkv_prewarm_skipped_count: int = 0
    layerkv_prewarm_skipped_reason: str = ""
    ...
    profile_forward_begin_bookkeeping_ms: float = 0.0
    profile_forward_begin_metadata_current_ms: float = 0.0
    profile_forward_begin_fastpath_check_ms: float = 0.0
    profile_forward_begin_expert_control_ms: float = 0.0
    profile_forward_begin_hotness_prepare_ms: float = 0.0
    profile_forward_begin_scheduler_control_ms: float = 0.0
    profile_forward_begin_extend_cleanup_ms: float = 0.0
    profile_cleanup_req_indices_ms: float = 0.0
    profile_cleanup_cursor_ms: float = 0.0
    profile_cleanup_global_scan_ms: float = 0.0
    profile_cleanup_global_drop_ms: float = 0.0
    profile_cleanup_per_layer_keys_ms: float = 0.0
    profile_cleanup_per_layer_drop_ms: float = 0.0
    profile_cleanup_per_layer_loop_ms: float = 0.0
    profile_cleanup_per_layer_run_range_ms: float = 0.0
    profile_cleanup_per_layer_event_sync_ms: float = 0.0
    profile_cleanup_per_layer_collect_ms: float = 0.0
    profile_cleanup_per_layer_free_locs_ms: float = 0.0
    profile_cleanup_per_layer_refresh_allocator_ms: float = 0.0
    profile_cleanup_per_layer_host_free_ms: float = 0.0
    profile_cleanup_refresh_stats_ms: float = 0.0
    profile_cleanup_drop_entries_ms: float = 0.0
    profile_cleanup_finished_ms: float = 0.0
    profile_cleanup_release_ms: float = 0.0
    ...
    profile_kvc_evict_target_calc_ms: float = 0.0
    profile_kvc_evict_prune_ms: float = 0.0
    profile_kvc_evict_backend_check_ms: float = 0.0
    profile_kvc_evict_prepared_consume_ms: float = 0.0
    profile_kvc_evict_schedule_consume_ms: float = 0.0
    profile_kvc_evict_schedule_active_lens_ms: float = 0.0
    profile_kvc_evict_schedule_entry_check_ms: float = 0.0
    profile_kvc_evict_schedule_capacity_check_ms: float = 0.0
    profile_kvc_evict_selected_stats_ms: float = 0.0
    profile_kvc_evict_prepare_entries_ms: float = 0.0
    profile_kvc_evict_host_prealloc_ms: float = 0.0
    profile_kvc_evict_async_mark_ms: float = 0.0
    profile_kvc_layer_evict_finalize_ms: float = 0.0
    profile_kvc_layer_evict_commit_ms: float = 0.0
    kvc_layer_evict_commit_count: int = 0
    kvc_layer_evict_commit_token_count: int = 0
    kvc_evict_host_prealloc_count: int = 0
    kvc_evict_host_prealloc_hit_count: int = 0
    kvc_evict_host_prealloc_invalid_count: int = 0
    kvc_evict_host_prealloc_token_count: int = 0
    profile_req_to_token_rewrite_ms: float = 0.0
    profile_virtual_select_ms: float = 0.0
    profile_virtual_plan_cache_lookup_ms: float = 0.0
    profile_virtual_plan_sort_ms: float = 0.0
    profile_virtual_host_order_ms: float = 0.0
    profile_virtual_plan_key_ms: float = 0.0
    profile_virtual_plan_lookup_only_ms: float = 0.0
    profile_virtual_index_build_ms: float = 0.0
    virtual_kvc_plan_cache_hit_count: int = 0
    virtual_kvc_plan_cache_miss_count: int = 0
    virtual_kvc_plan_cache_reuse_token_count: int = 0
    virtual_kvc_host_order_plan_count: int = 0
    virtual_kvc_host_order_plan_token_count: int = 0
    ...
    profile_virtual_prefetch_next_layer_ms: float = 0.0
    profile_virtual_prefetch_demand_ms: float = 0.0
    profile_virtual_prefetch_cache_lookup_ms: float = 0.0
    profile_virtual_prefetch_buffer_select_ms: float = 0.0
    profile_virtual_prefetch_setup_ms: float = 0.0
    profile_virtual_prefetch_reload_call_ms: float = 0.0
    profile_virtual_prefetch_record_ms: float = 0.0
    ...
    profile_virtual_reload_event_record_ms: float = 0.0
    profile_virtual_reload_slice_path_ms: float = 0.0
    profile_virtual_reload_span_path_ms: float = 0.0
    profile_virtual_reload_span_coalesce_check_ms: float = 0.0
    profile_virtual_reload_span_bulk_copy_ms: float = 0.0
    profile_virtual_reload_span_fused_ms: float = 0.0
    profile_virtual_reload_span_scatter_ms: float = 0.0
    profile_virtual_reload_index_path_ms: float = 0.0
    profile_virtual_reload_tensor_h2d_ms: float = 0.0
    profile_virtual_reload_device_write_ms: float = 0.0
    ...
    virtual_kvc_reload_span_coalesce_count: int = 0
    virtual_kvc_reload_span_coalesce_token_count: int = 0
    virtual_kvc_reload_span_coalesce_copied_token_count: int = 0
    virtual_kvc_reload_span_direct_copy_count: int = 0
    virtual_kvc_reload_span_direct_copy_token_count: int = 0
    virtual_kvc_reload_span_fused_count: int = 0
    virtual_kvc_reload_span_fused_token_count: int = 0
    virtual_kvc_reload_span_fused_fallback_count: int = 0
