...
CSV_FIELDS = [
    ...
    "expert_install_prealloc_submit_ms",
    "expert_install_prealloc_ready_count",
    "expert_install_prealloc_reuse_count",
    "expert_install_prealloc_pending_count",
    "expert_install_prealloc_fallback_count",
    "expert_install_prealloc_wait_count",
    "expert_install_compact_pool_alloc_count",
    "expert_install_compact_pool_reuse_count",
    "expert_install_compact_pool_release_count",
    "expert_install_compact_pool_drop_count",
    "expert_install_compact_pool_bytes",
    ...
    "expert_hotness_record_count",
    "expert_hotness_record_fast_count",
    "expert_hotness_record_safe_count",
    "expert_hotness_sync_fallback_count",
    "expert_hotness_sample_skip_count",
    "expert_hotness_snapshot_count",
    "expert_hotness_snapshot_issue_count",
    "expert_hotness_snapshot_ready_count",
    "expert_hotness_snapshot_drop_count",
    "expert_hotness_snapshot_deferred_count",
    "expert_hotness_snapshot_forced_count",
    "expert_hotness_ones_reuse_count",
    "expert_candidate_snapshot_issue_count",
    "expert_candidate_snapshot_ready_count",
    "expert_candidate_snapshot_drop_count",
    "expert_candidate_order_hit_count",
    "expert_candidate_order_miss_count",
    "expert_copy_descriptor_count",
    "expert_copy_descriptor_d2h_count",
    "expert_copy_descriptor_h2d_count",
    "expert_copy_descriptor_param_count",
    "expert_copy_descriptor_bytes",
    "expert_copy_descriptor_install_count",
    "expert_copy_descriptor_evict_count",
    "expert_copy_descriptor_materialize_count",
    ...
    "expert_cpu_backing_pool_release_count",
    "expert_cpu_backing_pool_drop_count",
    "expert_cpu_backing_pool_bytes",
    "expert_cpu_backing_pool_limit_bytes",
    ...
    "expert_topk_gpu_remap_count",
    "expert_topk_gpu_remap_fallback_count",
    "expert_topk_gpu_remap_missing_count",
    "expert_topk_gpu_remap_error_count",
    ...
    "profile_decode_critical_path_ms",
    "profile_decode_batch_count",
    ...
    "profile_expert_topk_rewrite_ms",
